 ...
 * <ul>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getOrgid <em>Orgid</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getOrgcode <em>Orgcode</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getOrgname <em>Orgname</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getOrglevel <em>Orglevel</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getOrgdegree <em>Orgdegree</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getOrgseq <em>Orgseq</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getOrgtype <em>Orgtype</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getOrgaddr <em>Orgaddr</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getZipcode <em>Zipcode</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getManaposition <em>Manaposition</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getManagerid <em>Managerid</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getOrgmanager <em>Orgmanager</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getLinkman <em>Linkman</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getLinktel <em>Linktel</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getWeburl <em>Weburl</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getStartdate <em>Startdate</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getEnddate <em>Enddate</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getArea <em>Area</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getCreatetime <em>Createtime</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getLastupdate <em>Lastupdate</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getUpdator <em>Updator</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getSortno <em>Sortno</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getIsleaf <em>Isleaf</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getSubcount <em>Subcount</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getRemark <em>Remark</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getTenantId <em>TenantId</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getAppId <em>AppId</em>}</li>
 *   <li>{@link com.primeton.train.expense.expensedataset.impl.OrgOrganizationImpl#getParentorgid <em>Parentorgid</em>}</li>
 * </ul>
 * </p>
 *
...
public class OrgOrganizationImpl extends ExtendedDataObjectImpl implements OrgOrganization {
	...
	public final static int INDEX_PARENTORGID = 29;
	public static final int SDO_PROPERTY_COUNT = 30;
