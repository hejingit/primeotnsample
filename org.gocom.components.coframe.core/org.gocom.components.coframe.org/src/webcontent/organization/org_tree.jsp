...
<div id="orgRemovePrompt" style="width:100%;display:none;">
   <table>
     ...
     <tr>
       <td style="height:27px;*height:0px">
         &nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
	...
	function onNodeClick(e){
		if (currentNode._state!="removed"&&currentNode && e.node.nodeType==currentNode.nodeType){
			currentNode = e.node;
...
//		}
	...
	function openDialog(params) {
		...
		openParams.ondestroy || (openParams.ondestroy = function (action) {
			if (action == "ok") {
				refreshNode(searchParentOrgNode(getSelectedNode()));
				var currentTab = nui.get("orgTabs").getActiveTab();
				nui.get("orgTabs").reloadTab(currentTab);
			}
		});
