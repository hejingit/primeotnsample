...
public class FunctionAuthServiceBean {
	...
	public static List<Map> getFunctionCheckedTree(List<Map> functions, String roleId){
	...
	public synchronized static boolean saveAuthFunctionsBatch(DataObject[] dataObjects, String roleId){
		Party party = getParty(roleId);
