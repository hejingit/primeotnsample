 ...
 */
public class CapUserService extends CoframeDASDaoSupport implements ICapUserService {
	public static final String SPRING_MENU_BEAN = "CapUserService";
	 ...
	 * @param capUser
	 */
	public void updateLastLogin(CapUser capUser) {
		if(capUser != null) {
