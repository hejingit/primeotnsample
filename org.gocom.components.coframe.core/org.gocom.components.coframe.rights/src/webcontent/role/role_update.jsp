	...
	<div id="form1" >
		...
		<table style="width:100%;" class="nui-form-table">
			<tr>
				...
				<td class="nui-form-label" style="width:20%;"><label for="capRole.roleCode$text">角色代码：</label></td>
				<td style="width:30%;"><input id="capRole.roleCode" class="nui-textbox" style="width:100%;" name="capRole.roleCode" required="true" onvalidation="checkRoleCode" /></td>
				<td class="nui-form-label" style="width:20%;"><label for="capRole.roleName$text">角色名称：</label></td>
				<td><input id="capRole.roleName" class="nui-textbox" style="width:100%;" name="capRole.roleName" required="true"/></td>
			</tr>
			<tr class="odd">
				<td class="nui-form-label"><label for="capRole.roleDesc$text">角色描述：</label></td>
				<td colspan="3"><textarea id="capRole.roleDesc" class="nui-textarea" style="width:100%;" name="capRole.roleDesc"></textarea></td>
			</tr>
		</table>
	</div>
</div>
