   ...
   <table style="width:100%;height:100%;*width:99%;*height:90%;">
      ...
      <tr>
         <td style="width:40%;height:100%;border:1px solid #878787;vertical-align:top;">
            <ul id="tree1" class="nui-tree" style="width:100%;" url="org.gocom.components.coframe.auth.partyauth.ManageableRes.getManageableGroup.biz.ext";
...
<script type="text/javascript">
    ...
    function onBeforeTreeLoad(e) {
    	if(e.data.nodeId==""||!e.data.nodeId){
    		...
    		e.url = "org.gocom.components.coframe.org.group.querySubGroup.biz.ext";
    	}
    ...
    function SetData(e){
       ...
       var orgs;
       $.ajax({
            url: "org.gocom.components.coframe.org.groupAuth.getManagedGroupByRoleId.biz.ext",
            type: 'POST',
            data: json,
            cache: false,
            	...
            	if(res.exception || res.data == false) {
            		...
            		if(groups!=""){
				       for(var i=0;i<groups.length;i++){
				          var node ={
				             nodeId:groups[i].groupid,
				             nodeName:groups[i].groupname
				          };
				          listbox.addItem(node);
				       }
			       }
	...
	function saveTree(e){
		...
		var groupDatas = GetData();
		var json = nui.encode({groups:groupDatas,roleId:"<%=request.getParameter("roleId") %>"});
        $.ajax({
            url: "org.gocom.components.coframe.org.groupAuth.saveGroupAuth.biz.ext",
            type: 'POST',
            data: json,
            cache: false,
            contentType:'text/json',
