...
<div style="padding-top:5px;*height:90%;">
	<form id="form">
		...
		<table style="width:100%;table-layout:fixed;" class="nui-form-table" >
			<tr>
				...
				<td colspan="3"><input id="haddress" name="employee.haddress" class="nui-textbox nui-form-input" style="width:80%;"  vtype="maxLength:128"/></td>
			</tr>
			<tr class="odd">
				<td class="nui-form-label"><label for="hzipcode$text">家庭邮编：</label></td>
				<td><input id="hzipcode" name="employee.hzipcode" class="nui-textbox nui-form-input" /></td>
				<td class="nui-form-label" style="*width:20%;"><label for="htel$text">家庭电话：</label></td>
			...
			<tr>
				...
				<td class="nui-form-label" style="*width:20%;"><label for="weibo$text">微博：</label></td>
				<td><input id="weibo" name="employee.weibo" class="nui-textbox nui-form-input" style="width:80%;" vtype="maxLength:255"/></td>
			</tr>	
			<tr class="odd">
				<td class="nui-form-label"><label for="pemail$text">私人邮箱：</label></td>
				<td><input id="pemail" name="employee.pemail" class="nui-textbox nui-form-input" vtype="email"/></td>
				<td class="nui-form-label" style="*width:20%;"><label for="oemail$text">办公室邮箱：</label></td>
				<td><input id="oemail" name="employee.oemail" class="nui-textbox nui-form-input" vtype="email;rangeLength:0,128" /></td>
			</tr>				
			<tr>
			...
			<tr class="odd">	
				...
				<td class="nui-form-label" style="*width:20%;"><label for="faxno$text">传真号码：</label></td>
			...
			<tr>
				...
				<td class="nui-form-label" style="*width:20%;"><label for="party$text">政治面貌：</label></td>
			...
			<tr class="odd">
				...
				<td class="nui-form-label" style="*width:20%;"><label for="degree$text">职级：</label></td>
			...
			<tr>
				<td class="nui-form-label" style="*width:20%;"><label for="specialty$text">可管理角色：</label></td>
