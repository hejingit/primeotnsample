		        ...
		        <div class="fieldset-body">
		            <table style="width:100%;table-layout:fixed;" class="nui-form-table" >
						...
						<tr class="odd">
							...
							<td><input id="menutype" name="user.menutype" data="data" emptyText="请选择" valueField="dictID" textField="dictName" class="nui-dictcombobox" dictTypeId="COF_SKINLAYOUT" value="default" /></td>
						</tr>	
						<tr>
		...
		<div id="form2">
			<table style="width:100%;table-layout:fixed;" class="nui-form-table" >				
				...
				<tr class="odd">
					...
					<td><input id="ozipcode" name="employee.ozipcode" class="nui-textbox nui-form-input"  vtype="int;rangeLength:0,6"/></td>
				...
				<tr class="odd">
					...
					<td colspan="3"><input id="workexp" name="employee.workexp" class="nui-textarea nui-form-input" style="width:410px;" vtype="maxLength:512"/></td>
				</tr>			
				<tr>
					<td class="nui-form-label"><label for="remark$text">备注：</label></td>
					<td colspan="3"><input id="remark" name="employee.remark" class="nui-textarea nui-form-input" style="width:410px;" vtype="maxLength:512"/></td>
				</tr>
			</table>
		</div>
	</div>
