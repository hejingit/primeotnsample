    ...
    <div id="form1" style="padding:5px;">
	  <table style="width:100%;table-layout:fixed;" id="table1" class="table" >
		...
		<tr>
			...
			<td>
				<input name="criteria._expr[4].orgid" textName="orgname" class="nui-buttonedit searchbox" showclose="true" oncloseclick="clear" onbuttonclick="selectOrg" style="width:80%" allowinput="false"/>
