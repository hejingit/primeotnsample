...
/*修复bug 20140915 liudong
INSERT INTO APP_FUNCTION (FUNCCODE,FUNCNAME,FUNCDESC,FUNCACTION,PARAINFO,ISCHECK,FUNCTYPE,ISMENU,APP_ID,TENANT_ID,FUNCGROUPID) VALUES ('user_auth','用户授权',NULL,'/coframe/rights/user/user_auth.jsp',NULL,'1','page','0',NULL,'default',5);
INSERT INTO APP_FUNCTION (FUNCCODE,FUNCNAME,FUNCDESC,FUNCACTION,PARAINFO,ISCHECK,FUNCTYPE,ISMENU,APP_ID,TENANT_ID,FUNCGROUPID) VALUES ('position_sub_add','添加下级岗位',NULL,'/coframe/org/position/position_sub_add.jsp',NULL,'1','page','0',NULL,'default',6);
INSERT INTO APP_FUNCTION (FUNCCODE,FUNCNAME,FUNCDESC,FUNCACTION,PARAINFO,ISCHECK,FUNCTYPE,ISMENU,APP_ID,TENANT_ID,FUNCGROUPID) VALUES ('position_sub_update','修改下级岗位',NULL,'/coframe/org/position/position_sub_update.jsp',NULL,'1','page','0',NULL,'default',6);
INSERT INTO APP_FUNCTION (FUNCCODE,FUNCNAME,FUNCDESC,FUNCACTION,PARAINFO,ISCHECK,FUNCTYPE,ISMENU,APP_ID,TENANT_ID,FUNCGROUPID) VALUES ('group_tree','查看功能组',NULL,'/coframe/org/group/group_tree.jsp',NULL,'1','page','0',NULL,'default',6);
INSERT INTO APP_FUNCTION (FUNCCODE,FUNCNAME,FUNCDESC,FUNCACTION,PARAINFO,ISCHECK,FUNCTYPE,ISMENU,APP_ID,TENANT_ID,FUNCGROUPID) VALUES ('group_add','新增功能组',NULL,'/coframe/org/group/group_add.jsp',NULL,'1','page','0',NULL,'default',6);
INSERT INTO APP_FUNCTION (FUNCCODE,FUNCNAME,FUNCDESC,FUNCACTION,PARAINFO,ISCHECK,FUNCTYPE,ISMENU,APP_ID,TENANT_ID,FUNCGROUPID) VALUES ('group_update','编辑功能组',NULL,'/coframe/org/group/group_update.jsp',NULL,'1','page','0',NULL,'default',6);
INSERT INTO APP_FUNCTION (FUNCCODE,FUNCNAME,FUNCDESC,FUNCACTION,PARAINFO,ISCHECK,FUNCTYPE,ISMENU,APP_ID,TENANT_ID,FUNCGROUPID) VALUES ('pos_group_add','新增工作组下级岗位',NULL,'/coframe/org/group/position_group_add.jsp',NULL,'1','page','0',NULL,'default',6);
INSERT INTO APP_FUNCTION (FUNCCODE,FUNCNAME,FUNCDESC,FUNCACTION,PARAINFO,ISCHECK,FUNCTYPE,ISMENU,APP_ID,TENANT_ID,FUNCGROUPID) VALUES ('pos_group_update','编辑工作组下级岗位',NULL,'/coframe/org/group/position_group_update.jsp',NULL,'1','page','0',NULL,'default',6);
INSERT INTO APP_FUNCTION (FUNCCODE,FUNCNAME,FUNCDESC,FUNCACTION,PARAINFO,ISCHECK,FUNCTYPE,ISMENU,APP_ID,TENANT_ID,FUNCGROUPID) VALUES ('emp_group_add','新增工作组员工',NULL,'/coframe/org/group/employee_groupposi_add.jsp',NULL,'1','page','0',NULL,'default',6);
INSERT INTO APP_FUNCTION (FUNCCODE,FUNCNAME,FUNCDESC,FUNCACTION,PARAINFO,ISCHECK,FUNCTYPE,ISMENU,APP_ID,TENANT_ID,FUNCGROUPID) VALUES ('emp_group_update','编辑工作组员工',NULL,'/coframe/org/employee/employee_basicinfo_update.jsp',NULL,'1','page','0',NULL,'default',6);
INSERT INTO APP_FUNCTION (FUNCCODE,FUNCNAME,FUNCDESC,FUNCACTION,PARAINFO,ISCHECK,FUNCTYPE,ISMENU,APP_ID,TENANT_ID,FUNCGROUPID) VALUES ('emps_group_update','编辑工作组员工详细信息',NULL,'/coframe/org/employee/employee_detailinfo_update.jsp',NULL,'1','page','0',NULL,'default',6);
#commented by yangyong , 工作组功能不能用；已和liudong确认，可以删除
*/
...
INSERT INTO APP_MENU (MENUID,MENUNAME,MENULABEL,MENUCODE,ISLEAF,PARAMETER,UIENTRY,MENULEVEL,ROOTID,DISPLAYORDER,IMAGEPATH,EXPANDPATH,MENUSEQ,OPENMODE,SUBCOUNT,APPID,FUNCCODE,APP_ID,TENANT_ID,PARENTSID) VALUES ('4','菜单管理','菜单管理','menu_menu_manager','1',NULL,NULL,2,NULL,4,NULL,NULL,'.1.4.',NULL,0,NULL,'menu_manage',NULL,'default','1');
...
INSERT INTO APP_MENU (MENUID,MENUNAME,MENULABEL,MENUCODE,ISLEAF,PARAMETER,UIENTRY,MENULEVEL,ROOTID,DISPLAYORDER,IMAGEPATH,EXPANDPATH,MENUSEQ,OPENMODE,SUBCOUNT,APPID,FUNCCODE,APP_ID,TENANT_ID,PARENTSID) VALUES ('6','角色管理','角色管理','menu_role_manager','1',NULL,NULL,2,NULL,5,NULL,NULL,'.1.6.',NULL,0,NULL,'role_manager',NULL,'default','1');
INSERT INTO APP_MENU (MENUID,MENUNAME,MENULABEL,MENUCODE,ISLEAF,PARAMETER,UIENTRY,MENULEVEL,ROOTID,DISPLAYORDER,IMAGEPATH,EXPANDPATH,MENUSEQ,OPENMODE,SUBCOUNT,APPID,FUNCCODE,APP_ID,TENANT_ID,PARENTSID) VALUES ('7','用户管理','用户管理','menu_user_manager','1',NULL,NULL,2,NULL,7,NULL,NULL,'.1.7.',NULL,0,NULL,'user_list',NULL,'default','1');
...
INSERT INTO APP_MENU (MENUID,MENUNAME,MENULABEL,MENUCODE,ISLEAF,PARAMETER,UIENTRY,MENULEVEL,ROOTID,DISPLAYORDER,IMAGEPATH,EXPANDPATH,MENUSEQ,OPENMODE,SUBCOUNT,APPID,FUNCCODE,APP_ID,TENANT_ID,PARENTSID) VALUES ('50','设置安全策略','设置安全策略','menu_access_rule','1',NULL,NULL,2,NULL,2,NULL,NULL,'.1.50.',NULL,0,NULL,'access_rule',NULL,'default','1');
INSERT INTO APP_MENU (MENUID,MENUNAME,MENULABEL,MENUCODE,ISLEAF,PARAMETER,UIENTRY,MENULEVEL,ROOTID,DISPLAYORDER,IMAGEPATH,EXPANDPATH,MENUSEQ,OPENMODE,SUBCOUNT,APPID,FUNCCODE,APP_ID,TENANT_ID,PARENTSID) VALUES ('51','配置业务字典','配置业务字典','menu_dict_manager','1',NULL,NULL,2,NULL,3,NULL,NULL,'.1.51.',NULL,0,NULL,'dict_manager',NULL,'default','1');
INSERT INTO APP_MENU (MENUID,MENUNAME,MENULABEL,MENUCODE,ISLEAF,PARAMETER,UIENTRY,MENULEVEL,ROOTID,DISPLAYORDER,IMAGEPATH,EXPANDPATH,MENUSEQ,OPENMODE,SUBCOUNT,APPID,FUNCCODE,APP_ID,TENANT_ID,PARENTSID) values ('52', '工作组管理', '工作组管理', 'groupconfig', '1', null, null, 2, null, 2, null, null, '.2.52.', null, 0, null, 'groupTree', null, 'default', '2');
...
INSERT INTO CAP_ROLE (ROLE_ID,TENANT_ID,ROLE_CODE,ROLE_NAME,ROLE_DESC,CREATEUSER,CREATETIME) VALUES ('-1', 'default', 'bpsmanager', '流程管理员', 'BPS Workspace 应用流程管理员', null, null);
INSERT INTO CAP_ROLE (ROLE_ID,TENANT_ID,ROLE_CODE,ROLE_NAME,ROLE_DESC,CREATEUSER,CREATETIME) VALUES ('-2', 'default', 'bpscustom', '流程定制员', 'BPS Workspace 业务流程定制', null, null);
INSERT INTO CAP_ROLE (ROLE_ID,TENANT_ID,ROLE_CODE,ROLE_NAME,ROLE_DESC,CREATEUSER,CREATETIME) VALUES ('-3', 'default', 'bpsconfig', '流程配置员', 'BPS Workspace 业务流程配置', null, null);
INSERT INTO CAP_ROLE (ROLE_ID,TENANT_ID,ROLE_CODE,ROLE_NAME,ROLE_DESC,CREATEUSER,CREATETIME) VALUES ('-4', 'default', 'bpsbizcat', '目录管理员', 'BPS Workspace 业务目录管理', null, null);
INSERT INTO CAP_ROLE (ROLE_ID,TENANT_ID,ROLE_CODE,ROLE_NAME,ROLE_DESC,CREATEUSER,CREATETIME) VALUES ('-5', 'default', 'bpsstatis', '统计分析员', 'BPS Workspace 统计分析', null, null);
/*USER*/
INSERT INTO CAP_USER (OPERATOR_ID,TENANT_ID,USER_ID,PASSWORD,INVALDATE,USER_NAME,AUTHMODE,STATUS,UNLOCKTIME,MENUTYPE,LASTLOGIN,ERRCOUNT,STARTDATE,ENDDATE,VALIDTIME,MACCODE,IPADDRESS,EMAIL,CREATEUSER,CREATETIME) VALUES (1,'default','sysadmin','k2xvHUmCHWw=',NULL,'sysadmin','local','1',TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'),'default',TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'sysadmin',TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_USER (OPERATOR_ID,TENANT_ID,USER_ID,PASSWORD,INVALDATE,USER_NAME,AUTHMODE,STATUS,UNLOCKTIME,MENUTYPE,LASTLOGIN,ERRCOUNT,STARTDATE,ENDDATE,VALIDTIME,MACCODE,IPADDRESS,EMAIL,CREATEUSER,CREATETIME) VALUES ('-1', 'default', 'tiger', 'k2xvHUmCHWw=', null, 'tiger', 'local', '1', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'), 'default', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'), null, null, null, null, null, null, null, 'sysadmin', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_USER (OPERATOR_ID,TENANT_ID,USER_ID,PASSWORD,INVALDATE,USER_NAME,AUTHMODE,STATUS,UNLOCKTIME,MENUTYPE,LASTLOGIN,ERRCOUNT,STARTDATE,ENDDATE,VALIDTIME,MACCODE,IPADDRESS,EMAIL,CREATEUSER,CREATETIME) VALUES ('-2', 'default', 'goose', 'k2xvHUmCHWw=', null, 'goose', 'local', '1', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'), 'default', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'), null, null, null, null, null, null, null, 'sysadmin', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_USER (OPERATOR_ID,TENANT_ID,USER_ID,PASSWORD,INVALDATE,USER_NAME,AUTHMODE,STATUS,UNLOCKTIME,MENUTYPE,LASTLOGIN,ERRCOUNT,STARTDATE,ENDDATE,VALIDTIME,MACCODE,IPADDRESS,EMAIL,CREATEUSER,CREATETIME) VALUES ('-3', 'default', 'fish', 'k2xvHUmCHWw=', null, 'fish', 'local', '1', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'), 'default', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'), null, null, null, null, null, null, null, 'sysadmin', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_USER (OPERATOR_ID,TENANT_ID,USER_ID,PASSWORD,INVALDATE,USER_NAME,AUTHMODE,STATUS,UNLOCKTIME,MENUTYPE,LASTLOGIN,ERRCOUNT,STARTDATE,ENDDATE,VALIDTIME,MACCODE,IPADDRESS,EMAIL,CREATEUSER,CREATETIME) VALUES ('-4', 'default', 'snoppy', 'k2xvHUmCHWw=', null, 'snoppy', 'local', '1', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'), 'default', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'), null, null, null, null, null, null, null, 'sysadmin', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_USER (OPERATOR_ID,TENANT_ID,USER_ID,PASSWORD,INVALDATE,USER_NAME,AUTHMODE,STATUS,UNLOCKTIME,MENUTYPE,LASTLOGIN,ERRCOUNT,STARTDATE,ENDDATE,VALIDTIME,MACCODE,IPADDRESS,EMAIL,CREATEUSER,CREATETIME) VALUES ('-5', 'default', 'micky', 'k2xvHUmCHWw=', null, 'micky', 'local', '1', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'), 'default', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'), null, null, null, null, null, null, null, 'sysadmin', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_USER (OPERATOR_ID,TENANT_ID,USER_ID,PASSWORD,INVALDATE,USER_NAME,AUTHMODE,STATUS,UNLOCKTIME,MENUTYPE,LASTLOGIN,ERRCOUNT,STARTDATE,ENDDATE,VALIDTIME,MACCODE,IPADDRESS,EMAIL,CREATEUSER,CREATETIME) VALUES ('-6', 'default', 'kitty', 'k2xvHUmCHWw=', null, 'kitty', 'local', '1', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'), 'default', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'), null, null, null, null, null, null, null, 'sysadmin', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));

/*EMPLOYEE*/
INSERT INTO ORG_EMPLOYEE (EMPID,EMPCODE,OPERATORID,USERID,EMPNAME,REALNAME,GENDER,BIRTHDATE,POSITION,EMPSTATUS,CARDTYPE,CARDNO,INDATE,OUTDATE,OTEL,OADDRESS,OZIPCODE,OEMAIL,FAXNO,MOBILENO,QQ,HTEL,HADDRESS,HZIPCODE,PEMAIL,PARTY,DEGREE,MAJOR,SPECIALTY,WORKEXP,REGDATE,CREATETIME,LASTMODYTIME,ORGIDLIST,ORGID,REMARK,TENANT_ID,APP_ID,WEIBO) VALUES (1,'sysadmin',1,'sysadmin','sysadmin','sysadmin',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'),TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'),NULL,NULL,NULL,'default',NULL,NULL);
...
INSERT INTO CAP_PARTYAUTH (ROLE_TYPE,PARTY_ID,PARTY_TYPE,ROLE_ID,TENANT_ID,CREATEUSER,CREATETIME) VALUES ('role', 'fish', 'user', '-1', 'default', 'sysadmin', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_PARTYAUTH (ROLE_TYPE,PARTY_ID,PARTY_TYPE,ROLE_ID,TENANT_ID,CREATEUSER,CREATETIME) VALUES ('role', 'fish', 'user', '-2', 'default', 'sysadmin', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_PARTYAUTH (ROLE_TYPE,PARTY_ID,PARTY_TYPE,ROLE_ID,TENANT_ID,CREATEUSER,CREATETIME) VALUES ('role', 'fish', 'user', '-3', 'default', 'sysadmin', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_PARTYAUTH (ROLE_TYPE,PARTY_ID,PARTY_TYPE,ROLE_ID,TENANT_ID,CREATEUSER,CREATETIME) VALUES ('role', 'goose', 'user', '-1', 'default', 'sysadmin',TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_PARTYAUTH (ROLE_TYPE,PARTY_ID,PARTY_TYPE,ROLE_ID,TENANT_ID,CREATEUSER,CREATETIME) VALUES ('role', 'goose', 'user', '-2', 'default', 'sysadmin',TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_PARTYAUTH (ROLE_TYPE,PARTY_ID,PARTY_TYPE,ROLE_ID,TENANT_ID,CREATEUSER,CREATETIME) VALUES ('role', 'goose', 'user', '-5', 'default', 'sysadmin',TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_PARTYAUTH (ROLE_TYPE,PARTY_ID,PARTY_TYPE,ROLE_ID,TENANT_ID,CREATEUSER,CREATETIME) VALUES ('role', 'micky', 'user', '-4', 'default', 'sysadmin',TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_PARTYAUTH (ROLE_TYPE,PARTY_ID,PARTY_TYPE,ROLE_ID,TENANT_ID,CREATEUSER,CREATETIME) VALUES ('role', 'snoppy', 'user', '-3', 'default', 'sysadmin',TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_PARTYAUTH (ROLE_TYPE,PARTY_ID,PARTY_TYPE,ROLE_ID,TENANT_ID,CREATEUSER,CREATETIME) VALUES ('role', 'snoppy', 'user', '-4', 'default', 'sysadmin', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_PARTYAUTH (ROLE_TYPE,PARTY_ID,PARTY_TYPE,ROLE_ID,TENANT_ID,CREATEUSER,CREATETIME) VALUES ('role', 'tiger', 'user', '-1', 'default', 'sysadmin', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_PARTYAUTH (ROLE_TYPE,PARTY_ID,PARTY_TYPE,ROLE_ID,TENANT_ID,CREATEUSER,CREATETIME) VALUES ('role', 'tiger', 'user', '-2', 'default', 'sysadmin',TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_PARTYAUTH (ROLE_TYPE,PARTY_ID,PARTY_TYPE,ROLE_ID,TENANT_ID,CREATEUSER,CREATETIME) VALUES ('role', 'tiger', 'user', '-3', 'default', 'sysadmin', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_PARTYAUTH (ROLE_TYPE,PARTY_ID,PARTY_TYPE,ROLE_ID,TENANT_ID,CREATEUSER,CREATETIME) VALUES ('role', 'tiger', 'user', '-4', 'default', 'sysadmin', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO CAP_PARTYAUTH (ROLE_TYPE,PARTY_ID,PARTY_TYPE,ROLE_ID,TENANT_ID,CREATEUSER,CREATETIME) VALUES ('role', 'tiger', 'user', '-5', 'default', 'sysadmin', TO_DATE('2013-03-16 12:00:37', 'YYYY-MM-DD HH24:MI:SS'));

/*ROLE RESOURCE AUTH*/

INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','application_add','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','application_edit','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','application_manage','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','auth_graph','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','employee_add','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','employee_auth','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','employee_update','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','funcgroup_add','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','funcgroup_edit','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','function_add','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','function_edit','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','function_role_auth','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','menu_add','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','menu_edit','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','menu_manage','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','org_add','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','org_auth','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','org_tree','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','org_update','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','party_auth','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','position_auth','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','position_org_add','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','position_org_update','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','reset_password','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','role_add','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','role_auth','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','role_manager','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','role_update','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','user_add','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','user_list','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','user_update','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','access_rule','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1','role','dict_manager','function','default','1','0','sysadmin',null);
INSERT INTO CAP_RESAUTH (PARTY_ID,PARTY_TYPE,RES_ID,RES_TYPE,TENANT_ID,RES_STATE,PARTY_SCOPE,CREATEUSER,CREATETIME) VALUES ('1', 'role', 'groupTree', 'function', 'default', '1', '0', 'sysadmin', null);
...
INSERT INTO EOS_UNIQUE_TABLE (NAME,CODE) VALUES ('AppFuncgroup.funcgroupid',1000);
...
INSERT INTO EOS_UNIQUE_TABLE (NAME,CODE) VALUES ('AppMenu.menuid',1000);
DELETE FROM EOS_UNIQUE_TABLE WHERE NAME='CapRole.roleId';
INSERT INTO EOS_UNIQUE_TABLE (NAME,CODE) VALUES ('CapRole.roleId',1000);
...
INSERT INTO EOS_UNIQUE_TABLE (NAME,CODE) VALUES ('CapUser.operatorId',1000);
DELETE FROM EOS_UNIQUE_TABLE WHERE NAME='OrgEmployee.empid';
INSERT INTO EOS_UNIQUE_TABLE (NAME,CODE) VALUES ('OrgEmployee.empid',1000);
...
DELETE FROM EOS_DICT_ENTRY WHERE DICTTYPEID='COFRAME_RULES_ENABLE';
DELETE FROM EOS_DICT_TYPE WHERE DICTTYPEID='COFRAME_RULES_ENABLE';
DELETE FROM EOS_DICT_ENTRY WHERE DICTTYPEID='COFRAME_RULES_TYPE';
DELETE FROM EOS_DICT_TYPE WHERE DICTTYPEID='COFRAME_RULES_TYPE';
