...
public class DefaultAuthManagerService implements IAuthManagerService {
	...
	public boolean delAuthResByRole(Party party) {
		try {
			...
			log.error("Delete AuthRes By Role failure, please do the operation again or contact the sysadmin.", t);
			return false;
		}
	}
	...
	public boolean delPartyAuthByRole(Party roleParty) {
		try {
			...
			log.error("Delete PartyAuth By Role failure, please do the operation again or contact the sysadmin.", t);
			return false;
		}
	}
